...
CREATE TABLE public.turma (
	...
	statuscurso varchar(50) NOT NULL,
...
INSERT INTO "public"."turma" ("codigo", "nome", "datainicio", "datafim", 
"statuscurso", "periodocurso") 
VALUES (1, '5ª Serie', '01/01/2024', '01/12/2024', 'Aberto','MATUTINO');

INSERT INTO "public"."turma" ("codigo", "nome", "datainicio", "datafim", 
"statuscurso",  "periodocurso") 
VALUES (2, '4ª Serie', '01/01/2024', '01/12/2024', 'Aberto','MATUTINO');


INSERT INTO "public"."turma" ("codigo", "nome", "datainicio", "datafim", 
"statuscurso", "periodocurso") 
VALUES (3, '3ª Serie', '01/01/2024', '01/12/2024', 'Aberto','MATUTINO');


INSERT INTO "public"."turma" ("codigo", "nome", "datainicio", "datafim", 
"statuscurso", "periodocurso") 
VALUES (4, '8ª Serie', '01/01/2024', '01/12/2024', 'Aberto','MATUTINO');

INSERT INTO "public"."materia" ("codigo", "turma", "nome") 
VALUES (1, 2, 'Matemática');

INSERT INTO "public"."materia" ("codigo", "turma", "nome") 
VALUES (2, 2, 'Portugues');

INSERT INTO "public"."materia" ("codigo", "turma", "nome") 
VALUES (3, 2, 'Geografia');

INSERT INTO "public"."materia" ("codigo", "turma", "nome") 
VALUES (4, 2, 'Historia');

INSERT INTO "public"."materia" ("codigo", "turma", "nome") 
VALUES (5, 2, 'Educação Fisica');

INSERT INTO "public"."materia" ("codigo", "turma", "nome") 
VALUES (6, 2, 'Inglês');


--UPDATE CAMPOS SERIAIS
...
VALUES ('1', '1', 'aluno', 'aluno'), 
       ('1', '2', 'professor', 'professor'), 
       ('1', '3', 'escola', 'escola'), 
       ('1', '4', 'turma', 'turma'), 
       ('1', '5', 'matéria', 'materia');
