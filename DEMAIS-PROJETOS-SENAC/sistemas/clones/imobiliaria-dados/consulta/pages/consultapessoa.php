...
function montaTabelaConsulta($aDadosPessoas){
    $html_tabela = '<div style="padding: 15px;">
                        <button class="btn btn-success" ><a href="pessoa.php?acao=INCLUSAO" style="color: white;">Incluir</a></button>
                    </div>';
    ...
    foreach ($aDadosPessoas as $pessoa){
        ...
        $html_dados_table .= "<td align='center'><button class=\"btn btn-warning\" onclick='alterarPessoa(" . $pessoa['pescodigo'] .")'>Alterar</button></td>";
        $html_dados_table .= "<td align='center'><button class=\"btn btn-danger\" onclick='excluirPessoa(" . $pessoa['pescodigo'] .")'>Excluir</button></td>";
                ...
                <div class="row">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="table-responsive" id="container-consulta">
									' . $html_tabela . '
								</div>
                            </div>
                        </div>
