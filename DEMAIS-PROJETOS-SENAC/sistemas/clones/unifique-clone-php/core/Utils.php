...
class Utils {
    ...
    public static function executaQuery($sql, $retornoBoolean = false){
        return self::getQuery()->executaQuery($sql, $retornoBoolean);
    }
    
    public static function select($sql){
        return self::getQuery()->select($sql);
    }
    
    public static function selectAll($sql){
        return self::getQuery()->selectAll($sql);
    }
