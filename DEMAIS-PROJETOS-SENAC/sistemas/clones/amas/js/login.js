...
function atualizaMenu(){
    ...
    let baseUrl = "https://associacaoaltosantana.vercel.app/";
    ...
    //         // Icone
    //         "bx bx-grid-alt",
    //         // funcao, se nao houver colocar vazio
    //         ""
    //     )
    // );
    ...
    const menu = ` <li id="aba-index">
                    ...
                    <li id="aba-eventos">
                        <a href="${baseUrl}eventos.html">
                            <i class='bx bx-box'></i>
                            <span class="links_name">Eventos</span>
                        </a>
                    </li>
                    <li id="aba-fia">
                        <a href="${baseUrl}fia.html">
                            <i class='bx bx-list-ul'></i>
                            <span class="links_name">FIA</span>
                        </a>
                    </li>
                    ...
                    <li id="aba-despesas">
                        <a href="${baseUrl}despesas.html">
                            <i class='bx bx-barcode'></i>
                            <span class="links_name">Despesas</span>
                        </a>
                    </li>
                    ...
                    <li id="aba-membros">
                        <a href="${baseUrl}membros.html">
                            <i class='bx bx-user'></i>
                            <span class="links_name">Membros</span>
                        </a>
                    </li>                    
                    <li id="aba-cora">
                        <a href="${baseUrl}cora.html">
                            <i class='bx bx-cog'></i>
                            <span class="links_name">Cora</span>
                        </a>
                    </li>
...
function login(){
    ...
    if(email == "admin@gmail.com" && senha == "Jessica.2024"){
